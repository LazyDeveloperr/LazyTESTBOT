...
async def start(client, message):
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('Holywood', url='https://t.me/LazyDeveloper'),
            InlineKeyboardButton('Bolywood️', url='https://t.me/LazyDeveloper'),
            InlineKeyboardButton('Tolywood', url='https://t.me/LazyDeveloper')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
